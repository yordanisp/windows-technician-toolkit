...
cd /d "%~dp0"
set "TOOLKIT_VERSION=1.2"
set "TOOLKIT_RELEASE=Safe disk cleanup and maintenance"
...
:maintenance_menu
cls
if "%choice%"=="5" cleanmgr.exe /verylowdisk
if "%choice%"=="6" start "" diskmgmt.msc
...
echo !GREEN!7^) Show CCM cache information!RESET!
...
if "%choice%"=="7" powershell -NoProfile -Command "Get-CimInstance -Namespace root\ccm\SoftMgmtAgent -ClassName CCM_CacheConfig -ErrorAction SilentlyContinue | Format-List *"
